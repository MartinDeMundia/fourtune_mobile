...
public class PreferenceConstants {
    ...
    public static final String PREFERENCE_SOUND_VOLUME= "soundVolume";
    public static final String PREFERENCE_MUSIC_VOLUME = "musicVolume";
    ...
    public static final String PREFERENCE_MAIN_NAME = "SuperMarioPrefs";
	
    public static final String PREFERENCE_SCORE_NAME = "SuperMarioScorePrefs";

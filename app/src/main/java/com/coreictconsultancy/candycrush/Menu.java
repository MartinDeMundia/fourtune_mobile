...
public class Menu extends BaseGameActivity implements IOnAreaTouchListener {
	...
	/** App Preferences **/
	com.coreictconsultancy.candycrush.AppPreferences _appPrefs;
	...
	public EngineOptions onCreateEngineOptions() {
		_appPrefs = new com.coreictconsultancy.candycrush.AppPreferences(getApplicationContext());
	...
	public void onCreateResources(OnCreateResourcesCallback pOnCreateResourcesCallback)
		...
		if ((showLeaderBoard != null) && (showLeaderBoard.equals("yes"))) {
			...
			Swarm.init(com.coreictconsultancy.candycrush.Menu.this, SWARM_APP_ID, SWARM_APP_KEY);
		...
		this.mBackGroundTextureRegion = BitmapTextureAtlasTextureRegionFactory
				.createFromAsset(this.mBackGroundTexture, this,"gfx/background.png", 0, 0);
	...
	public boolean onAreaTouched(TouchEvent pSceneTouchEvent,
		...
		if(pSceneTouchEvent.getAction()== MotionEvent.ACTION_UP)
		{
			if (pTouchArea.equals(mNewGame)) {
				...
				com.coreictconsultancy.candycrush.AppPreferences appPrefs = new com.coreictconsultancy.candycrush.AppPreferences(getApplicationContext());
...
//					Menu.this.finish();
				...
				Intent intent = new Intent();
				intent.putExtra("mode", "new");
				intent.setClass(this.getApplicationContext(), com.coreictconsultancy.candycrush.JewelsClassic.class);
				startActivity(intent);
				overridePendingTransition(R.anim.animation1, R.anim.animation2);
//				Menu.this.finish();
	...
	private void startGame(final String model) {
		...
		intent.setClass(this.getApplicationContext(), com.coreictconsultancy.candycrush.JewelsArcade.class);
		startActivity(intent);
		com.coreictconsultancy.candycrush.Menu.this.finish();
	}
	// ===========================================================
	// Additional MEthods
	// ===========================================================			

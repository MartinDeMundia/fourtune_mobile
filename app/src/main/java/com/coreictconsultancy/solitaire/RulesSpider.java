...
class RulesSpider extends Rules {
  ...
  public void Init(Bundle map) {
    ...
    // Anchor stacks
    for (int i = 0; i < 10; i++) {
      mCardAnchor[i] = com.coreictconsultancy.solitaire.CardAnchor.CreateAnchor(com.coreictconsultancy.solitaire.CardAnchor.GENERIC_ANCHOR, i, this);
      mCardAnchor[i].SetBuildSeq(com.coreictconsultancy.solitaire.GenericAnchor.SEQ_DSC);
      mCardAnchor[i].SetBuildSuit(com.coreictconsultancy.solitaire.GenericAnchor.SEQ_ANY);
      mCardAnchor[i].SetMoveSeq(com.coreictconsultancy.solitaire.GenericAnchor.SEQ_ASC);
      mCardAnchor[i].SetMoveSuit(com.coreictconsultancy.solitaire.GenericAnchor.SUIT_SAME);
      mCardAnchor[i].SetBehavior(com.coreictconsultancy.solitaire.GenericAnchor.PACK_MULTI);
      mCardAnchor[i].SetDisplay(com.coreictconsultancy.solitaire.GenericAnchor.DISPLAY_MIX);
      mCardAnchor[i].SetHack(com.coreictconsultancy.solitaire.GenericAnchor.DEALHACK);
    }

    mCardAnchor[10] = com.coreictconsultancy.solitaire.CardAnchor.CreateAnchor(com.coreictconsultancy.solitaire.CardAnchor.DEAL_FROM, 10, this);
    mCardAnchor[11] = com.coreictconsultancy.solitaire.CardAnchor.CreateAnchor(com.coreictconsultancy.solitaire.CardAnchor.DEAL_TO, 11, this);
    ...
    mDeck = new com.coreictconsultancy.solitaire.Deck(2, suits);
    int i = 54;
    while (i > 0) {
        ...
        if (card[anchor.GetCount()-1].GetValue() == 1) {
          ...
          if (val == 14) {
            ...
            if (mCardAnchor[11].GetCount() == mCardCount) {
              ...
              PostEarnings saveEarnings = new PostEarnings("1", "Spider",mView.GetContext());

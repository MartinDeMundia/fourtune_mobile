...
class CardAnchor {
  ...
  // Create a CardAnchor
  // -------------------
  public static com.coreictconsultancy.solitaire.CardAnchor CreateAnchor(int type, int number, Rules rules) {
    com.coreictconsultancy.solitaire.CardAnchor ret = null;
    switch (type) {
      case SEQ_SINK:
        ret = new com.coreictconsultancy.solitaire.SeqSink();
        break;
      case DEAL_FROM:
        ret = new com.coreictconsultancy.solitaire.DealFrom();
        break;
      case DEAL_TO:
        ret = new com.coreictconsultancy.solitaire.DealTo();
        break;
      case FREECELL_STACK:
        ret = new com.coreictconsultancy.solitaire.FreecellStack();
        break;
      case FREECELL_HOLD:
        ret = new com.coreictconsultancy.solitaire.FreecellHold();
        break;
      case GOLF_WASTE:
        ret = new com.coreictconsultancy.solitaire.GolfWaste();
        break;
      case GOLF_WRAPCARDS_WASTE:
        ret = new com.coreictconsultancy.solitaire.GolfWrapCardsWaste();
        break;
      case GOLF_STACK:
        ret = new com.coreictconsultancy.solitaire.GolfStack();
        break;
      case GENERIC_ANCHOR:
        ret = new com.coreictconsultancy.solitaire.GenericAnchor();
        break;
    }
    ret.SetRules(rules);
  ...
  public void AddMoveCard(com.coreictconsultancy.solitaire.MoveCard moveCard) {
  ...
  public boolean CanDropCard(com.coreictconsultancy.solitaire.MoveCard moveCard, int close) { return false; }
  ...
  // Functions to Draw
  // ----------------------------
  public void Draw(com.coreictconsultancy.solitaire.DrawMaster drawMaster, Canvas canvas) {
    if (mCardCount == 0) {
...
// Straight up default
class DealTo extends com.coreictconsultancy.solitaire.CardAnchor {
...
class SeqStack extends com.coreictconsultancy.solitaire.CardAnchor {
...
class DealFrom extends com.coreictconsultancy.solitaire.CardAnchor {
...
class SeqSink extends com.coreictconsultancy.solitaire.CardAnchor {
  ...
  @Override
  public boolean CanDropCard(com.coreictconsultancy.solitaire.MoveCard moveCard, int close) {
...
// Freecell stack
class FreecellStack extends com.coreictconsultancy.solitaire.SeqStack {
...
class FreecellHold extends com.coreictconsultancy.solitaire.CardAnchor {
...
// No build on King
class GolfWaste extends com.coreictconsultancy.solitaire.CardAnchor {
...
class GolfWrapCardsWaste extends com.coreictconsultancy.solitaire.CardAnchor {
...
class GolfStack extends com.coreictconsultancy.solitaire.CardAnchor {
...
// New Abstract
class GenericAnchor extends com.coreictconsultancy.solitaire.CardAnchor {
  ...
  public GenericAnchor(){
    super();
    SetStartSeq(com.coreictconsultancy.solitaire.GenericAnchor.SEQ_ANY);
    SetBuildSeq(com.coreictconsultancy.solitaire.GenericAnchor.SEQ_ANY);
    SetBuildWrap(false);
    SetBuildSuit(com.coreictconsultancy.solitaire.GenericAnchor.SUIT_ANY);
    SetDropoff(com.coreictconsultancy.solitaire.GenericAnchor.PACK_NONE);
    SetPickup(com.coreictconsultancy.solitaire.GenericAnchor.PACK_NONE);
    SetDisplay(com.coreictconsultancy.solitaire.GenericAnchor.DISPLAY_ALL);
    mSpacing = GetMaxSpacing();
    mHideHidden = false;
    mMaxHeight = Card.HEIGHT;
  }
  ...
  public void AddCard(Card card) {
    super.AddCard(card);
    CheckSizing();
    if (mHACK == com.coreictconsultancy.solitaire.GenericAnchor.DEALHACK){
      mRules.EventAlert(Rules.EVENT_STACK_ADD, this);
    }
  }
  ...
  @Override
  public boolean CanDropCard(com.coreictconsultancy.solitaire.MoveCard moveCard, int close) {
    if (mDROPOFF == com.coreictconsultancy.solitaire.GenericAnchor.PACK_NONE){
      return false;
    }
  ...
  public boolean CanBuildCard(com.coreictconsultancy.solitaire.MoveCard moveCard){
    Card card = moveCard.GetTopCard();
    // SEQ_ANY will allow all
    if (mBUILDSEQ == com.coreictconsultancy.solitaire.GenericAnchor.SEQ_ANY){
      return true;
    }
    Card topCard = mCardCount > 0 ? mCard[mCardCount - 1] : null;
    ...
    if (topCard == null) {
      // Check stack size
      if (mDROPOFF == com.coreictconsultancy.solitaire.GenericAnchor.PACK_LIMIT_BY_FREE){
      ...
      switch (mSTARTSEQ) {
        case com.coreictconsultancy.solitaire.GenericAnchor.START_KING:
          return card.GetValue() == Card.KING;
        case com.coreictconsultancy.solitaire.GenericAnchor.START_NONE:
          return false;
        case com.coreictconsultancy.solitaire.GenericAnchor.START_ANY:
        default:
          return true;
      }
    } else {
    ...
    //WRAP_WRAP=2;   //Building stacks wraps around
      case com.coreictconsultancy.solitaire.GenericAnchor.SEQ_ASC:
        if (value - tvalue != 1){
          return false;
        }
        break;
      case com.coreictconsultancy.solitaire.GenericAnchor.SEQ_DSC:
        if (tvalue - value != 1){
          return false;
        }
        break;
      case com.coreictconsultancy.solitaire.GenericAnchor.SEQ_SEQ:
    ...
    switch (mBUILDSUIT){
      case com.coreictconsultancy.solitaire.GenericAnchor.SUIT_RB:
        if (Math.abs(tsuit - suit)%2 == 0){  return false;  }
        break;
      case com.coreictconsultancy.solitaire.GenericAnchor.SUIT_OTHER:
        if (tsuit == suit){  return false;  }
        break;
      case com.coreictconsultancy.solitaire.GenericAnchor.SUIT_COLOR:
        if (Math.abs(tsuit - suit) != 2){  return false;  }
        break;
      case com.coreictconsultancy.solitaire.GenericAnchor.SUIT_SAME:
        if (tsuit != suit){  return false;  }
        break;
    }
    // Passes all rules
  ...
  public void Draw(com.coreictconsultancy.solitaire.DrawMaster drawMaster, Canvas canvas) {
    ...
    switch (mDISPLAY){
      case com.coreictconsultancy.solitaire.GenericAnchor.DISPLAY_ALL:
        for (int i = 0; i < mCardCount; i++) {
          drawMaster.DrawCard(canvas, mCard[i]);
        }
        break;
      case com.coreictconsultancy.solitaire.GenericAnchor.DISPLAY_HIDE:
        for (int i = 0; i < mCardCount; i++) {
          drawMaster.DrawHiddenCard(canvas, mCard[i]);
        }
        break;
      case com.coreictconsultancy.solitaire.GenericAnchor.DISPLAY_MIX:
        for (int i = 0; i < mCardCount; i++) {
          if (i < mHiddenCount) {
            drawMaster.DrawHiddenCard(canvas, mCard[i]);
          } else {
        ...
        break;
      case com.coreictconsultancy.solitaire.GenericAnchor.DISPLAY_ONE:
        for (int i = 0; i < mCardCount; i++) {
          if (i < mCardCount-1) {
            drawMaster.DrawHiddenCard(canvas, mCard[i]);
          } else {
  ...
  public int GetMovableCount() {
    ...
    if (visibleCount == 0 || mPICKUP == com.coreictconsultancy.solitaire.GenericAnchor.PACK_NONE){
      return 0;
    }
    int seq_allowed = 1;
    if (visibleCount > 1){
      ...
      do {
        ...
        h = true;
        switch (mMOVESEQ){
          case com.coreictconsultancy.solitaire.GenericAnchor.SEQ_ANY:
            h = true;
            break;
          case com.coreictconsultancy.solitaire.GenericAnchor.SEQ_ASC:
        ...
        switch (mMOVESUIT){
          case com.coreictconsultancy.solitaire.GenericAnchor.SUIT_ANY:
            h = true;
            break;
          case com.coreictconsultancy.solitaire.GenericAnchor.SUIT_COLOR:
    ...
    switch (mPICKUP){
      case com.coreictconsultancy.solitaire.GenericAnchor.PACK_NONE:
        return 0;
      case com.coreictconsultancy.solitaire.GenericAnchor.PACK_ONE:
        seq_allowed = Math.min(1, seq_allowed);
        break;
      case com.coreictconsultancy.solitaire.GenericAnchor.PACK_MULTI:
        break;
      case com.coreictconsultancy.solitaire.GenericAnchor.PACK_FIXED:
        //seq_allowed = Math.min( xmin, seq_allowed);
        break;
      case com.coreictconsultancy.solitaire.GenericAnchor.PACK_LIMIT_BY_FREE:

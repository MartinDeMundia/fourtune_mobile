...
class SelectCard {
  ...
  public com.coreictconsultancy.solitaire.CardAnchor GetAnchor() { return mCardAnchor; }
  public int GetCount() {
    if (mSelected == -1)
      return mCardCount;
  ...
  public void InitFromAnchor(com.coreictconsultancy.solitaire.CardAnchor cardAnchor) {
    mValid = true;
    mSelected = -1;

...
public class AnimateCard {
  ...
  public void MoveCards(Card[] card, com.coreictconsultancy.solitaire.CardAnchor anchor, int count, Runnable callback) {
    float x = anchor.GetX();
  ...
  public void MoveCard(Card card, com.coreictconsultancy.solitaire.CardAnchor anchor) {
    float x = anchor.GetX();
    float y = anchor.GetNewY();
    mCardAnchor = anchor;
    mCallback = null;

...
public class Stats {
  ...
  public Stats(final com.coreictconsultancy.solitaire.SolitaireCG solitaire, final com.coreictconsultancy.solitaire.SolitaireView view) {
    ...
    com.coreictconsultancy.solitaire.Rules rules = view.GetRules();

...
public class SolitaireCG extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    com.coreictconsultancy.solitaire.ConfigWrapper config = (com.coreictconsultancy.solitaire.ConfigWrapper)getLastNonConfigurationInstance();
    if (config != null) {
  ...
  public void onStart() {
    ...
    mSolitaireView.InitGame(mSettings.getInt("LastType", com.coreictconsultancy.solitaire.Rules.KLONDIKE));
    SplashScreen();
  }
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    switch (item.getItemId()) {
      case MENU_BAKERSGAME:
        ...
        editor.commit();
        mSolitaireView.InitGame(com.coreictconsultancy.solitaire.Rules.FREECELL);
        break;
      case MENU_BLACKWIDOW:
        editor.putInt("SpiderSuits", 1);
        editor.commit();
        mSolitaireView.InitGame(com.coreictconsultancy.solitaire.Rules.SPIDER);
        break;
      case MENU_FORTYTHIEVES:
        mSolitaireView.InitGame(com.coreictconsultancy.solitaire.Rules.FORTYTHIEVES);
        break;
      case MENU_FREECELL:
      ...
      case MENU_GOLF:
        ...
        editor.commit();
        mSolitaireView.InitGame(com.coreictconsultancy.solitaire.Rules.GOLF);
        break;
      ...
      case MENU_KLONDIKE_DEALONE:
        ...
        editor.commit();
        mSolitaireView.InitGame(com.coreictconsultancy.solitaire.Rules.KLONDIKE);
        break;
      ...
      case MENU_TRIPEAKS:
        editor.putBoolean("GolfWrapCards", false); //No build on King
        editor.commit();
        mSolitaireView.InitGame(com.coreictconsultancy.solitaire.Rules.TRIPEAKS);
        break;
  ...
  public Object onRetainNonConfigurationInstance() {
    final com.coreictconsultancy.solitaire.ConfigWrapper config = new com.coreictconsultancy.solitaire.ConfigWrapper();
  ...
  public void DisplayOptions() {
    ...
    Intent settingsActivity = new Intent(this, com.coreictconsultancy.solitaire.Preferences.class);
    startActivity(settingsActivity);
  }

  public void DisplayHelp() {
    mSolitaireView.SetTimePassing(false);
    Intent helpActivity = new Intent(this, com.coreictconsultancy.solitaire.Help.class);

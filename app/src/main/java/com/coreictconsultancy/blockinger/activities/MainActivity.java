...
import com.coreictconsultancy.blockinger.db.HighscoreOpenHelper;
import com.coreictconsultancy.blockinger.db.ScoreDataSource;
...
public class MainActivity extends ListActivity {
	 ...
	 */
	public static final String PLAYERNAME_KEY = "com.coreictconsultancy.blockinger.activities.playername";
	
	/** This key is used to access the player name, which is returned as an Intent from the gameactivity upon completion (gameover).
	 *  The Package Prefix is mandatory for Intent data
	 */
	public static final String SCORE_KEY = "com.coreictconsultancy.blockinger.activities.score";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.blockinger_main);
		...
		TextView pname = findViewById(R.id.nicknameEditView);
		String gamerName = GetPref(this, "Pref_Username");
		pname.setText(gamerName);
	    ...
	    donateDialog.setTitle("Fourtune");
	    donateDialog.setMessage("Developed by Core ICT Consultancy");

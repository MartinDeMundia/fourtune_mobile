...
import com.coreictconsultancy.blockinger.Row;
...
public class Board extends Component {
	...
	private int height;
	private int width;
	private com.coreictconsultancy.blockinger.Row topRow; // index 0
	private com.coreictconsultancy.blockinger.Row currentRow;
	private int currentIndex;
	private com.coreictconsultancy.blockinger.Row tempRow;
	...
	public Board(GameActivity ga) {
		...
		/* Init Board */
		topRow = new com.coreictconsultancy.blockinger.Row(width,host);
		currentIndex = 0;
		tempRow = topRow;
		currentRow = topRow;
		for(int i = 1; i < height; i++) {
			currentRow = new com.coreictconsultancy.blockinger.Row(width,host);
			currentIndex = i;
	...
	public com.coreictconsultancy.blockinger.Square get(int x, int y) {
		if(x < 0)
			return null;
		if(x > (width - 1))
			return null;
	...
	public void set(int x, int y, com.coreictconsultancy.blockinger.Square square) {
		if(x < 0)
			return;
		if(x > (width - 1))
			return;
	...
	public int clearLines(int dim) {
		valid = false;
		com.coreictconsultancy.blockinger.Row clearPointer = currentRow;
		int clearCounter = 0;
		for(int i = 0; i < dim; i++) {
	...
	public com.coreictconsultancy.blockinger.Row getTopRow() {
		return topRow;
	}

	public void finishClear(com.coreictconsultancy.blockinger.Row row) {
		valid = false;
		topRow = row;
		currentIndex++;
	...
	public void interruptClearAnimation() {
		...
		com.coreictconsultancy.blockinger.Row interator = topRow.above();
		for(int i = 0; i < height; i++) {
	...
	public com.coreictconsultancy.blockinger.Row getCurrentRow() {
		return currentRow;
	}
	...
	public void setCurrentRow(com.coreictconsultancy.blockinger.Row row) {
		currentRow = row;
	}

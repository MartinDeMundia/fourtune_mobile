...
public abstract class Piece {
	...
	protected com.coreictconsultancy.blockinger.Square pattern[][]; 	// square matrix
	protected com.coreictconsultancy.blockinger.Square rotated[][]; 	// square matrix
	private com.coreictconsultancy.blockinger.Square emptySquare;
	private Canvas cv;
	private Bitmap bm;
	...
	protected Piece(Context c, int dimension) {
		...
		emptySquare =  new com.coreictconsultancy.blockinger.Square(com.coreictconsultancy.blockinger.Square.type_empty,c);
		
		pattern = new com.coreictconsultancy.blockinger.Square[dim][dim]; // empty piece
		rotated = new com.coreictconsultancy.blockinger.Square[dim][dim];
		for(int i = 0; i < dim; i++) {
			for(int j = 0; j < dim; j++) {

...
public class RecordsQuickGameListAdapter extends ArrayAdapter<com.coreictconsultancy.maze.GameStats>{

	
	Context context;
	List<com.coreictconsultancy.maze.GameStats> stats;
	LevelsDB DB;
	
	public RecordsQuickGameListAdapter(Context context, int resource, List<com.coreictconsultancy.maze.GameStats> objects) {
	...
	public View getView( int position, View convertView, ViewGroup parent) {
		...
		com.coreictconsultancy.maze.GameStats stat  =  getItem(position);

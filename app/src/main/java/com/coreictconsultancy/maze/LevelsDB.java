...
//        	mDataBase = this.getWritableDatabase();
	...
	//no use for user
	void addLevel(com.coreictconsultancy.maze.MazeGenerator maze, int level) {
...
//		Log.d("quickgamestats","updated");
	...
	com.coreictconsultancy.maze.GameStats getQuickGameStats(int lvl) {
...
//		Log.d("rows",cursor.getCount()+"");
		...
		com.coreictconsultancy.maze.GameStats stats = new com.coreictconsultancy.maze.GameStats(lvl, totalWins_, totalLoses_, gamesPlayed_, fastestWin_);
	...
	com.coreictconsultancy.maze.MazeGenerator getMaze(int level) {
		
		String query = "SELECT * FROM "+levelsTable+" where "+this.level+"="+String.valueOf(level);
	    Cursor cursor = mDataBase.rawQuery(query, null);
//	    Log.d("query results",cursor.getCount()+"");
	    com.coreictconsultancy.maze.MazeGenerator maze = new com.coreictconsultancy.maze.MazeGenerator();

...
//			Log.d("db created","done");
		...
		final Builder quickGameBuilder = new Builder(this);
		...
		final Builder practiceGameBuilder = new Builder(this);
		...
		Builder rateAppBuilder = new Builder(com.coreictconsultancy.maze.MainActivity.this);
		...
		if(rateAppCounter != -1 && rateAppCounter%10 == 0) {
			...
			rateAppBuilder.setPositiveButton("Sure", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					editor.commit();
					startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.coreictconsultancy.maze")));

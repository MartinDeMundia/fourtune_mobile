...
public class GameView extends View {
	...
	int maxMoves;
	Paint paint;
	com.coreictconsultancy.maze.MazeGenerator mazeGenerator;
	String timeTaken;
	TextView moves;
	...
	public void intializeValues() {
		...
		if(gameMode <= 0) { //practice and quickgame
			...
			mazeGenerator = new com.coreictconsultancy.maze.MazeGenerator(rows,columns);
...
//		Log.d("rowsxcolumns",rows+"x"+columns);
	...
	public void gameOver(int flag) {
		...
		((com.coreictconsultancy.maze.GameActivity) getContext()).stopTimer = true;
		GameOver = true;
		
		if(flag == 0) {
			PostEarnings saveEarnings = new PostEarnings("" + this.level, "Maze", (com.coreictconsultancy.maze.GameActivity) getContext());
			...
			if (userId.equals("")) {
				...
				builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						Intent intent = new Intent(context,com.coreictconsultancy.fourtune.ui.Signin.class);
			...
			if (gameMode == -1)
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					if (gameMode == 1) { //Normal Game
						...
						activity.finish();
						Intent intent = new Intent(context, com.coreictconsultancy.maze.LevelsList.class);
						context.startActivity(intent);

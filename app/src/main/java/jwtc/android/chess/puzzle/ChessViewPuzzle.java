...
/*
    ...
    public void play() {
        ...
        if (_iPos > _num) {
            ...
            //post fourtune banks for chess game
            PostEarnings saveEarnings = new PostEarnings("" + _selectedLevel, "Chess", _parent);
            String userId = saveEarnings.getLoggedUser();
            if (userId.equals("")) {
                Intent intent = new Intent(_parent,com.coreictconsultancy.fourtune.ui.Signin.class);
